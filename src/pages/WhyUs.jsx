  ...
  return (
    <div className="min-h-screen bg-[#0c120c] text-white overflow-x-hidden">
      ...
      <div className="relative pt-28 sm:pt-32">
        ...
        >
          <div className="absolute inset-0 bg-linear-to-b from-black/80 via-[#0c120c]/70 to-[#0c120c]" />
        </div>
      ...
      <section className="px-6 lg:px-20 py-20">
        ...
        >
          ...
          <motion.div
            whileHover={{ y: -5 }}
            className="relative rounded-xl overflow-hidden bg-[#1b2636] border border-white/5 min-h-65 group"
          >
            <img
              src="/why.png"
              loading="lazy"
