...
export default function Whyheader() {
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 w-full z-50 flex items-center justify-between px-5 py-4 bg-[#0c120c]/80 backdrop-blur-md border-b border-white/10"
    >
      {/* LOGO */}
      ...
      {/* NAV LINKS */}
      <div className="hidden md:flex gap-10 text-[18px] font-medium text-gray-300 tracking-wide">
