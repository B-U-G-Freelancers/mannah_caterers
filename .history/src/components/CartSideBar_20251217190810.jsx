    ...
    <div className="w-full lg:w-[360px] flex-shrink-0">
      <div className="lg:sticky lg:top-[140px] flex flex-col gap-6">
        ...
        <div className="bg-[#022c1e] rounded-3xl border border-[#24473b] p-5 sm:p-6 shadow-2xl relative overflow-hidden">
          ...
          {/* CTA */}
          <button onClick={} className="w-full bg-[#d4af37] hover:bg-[#c29d4d] text-[#013220] py-4 rounded-full font-black text-sm uppercase tracking-wider shadow-lg shadow-yellow-900/20 transition-all active:scale-95 flex items-center justify-center gap-2">
