  ...
  return (
    <header className="sticky top-0 z-50 flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#24473b] bg-[#013220]/95 backdrop-blur-md px-4 sm:px-10 py-3 shadow-lg">
      ...
      <div className="flex flex-1 justify-end gap-8">
        ...
        <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 bg-s[#d4af37] hover:bg-[#c29d4d] transition-colors text-[#013220] text-sm font-bold leading-normal tracking-[0.015em]">
