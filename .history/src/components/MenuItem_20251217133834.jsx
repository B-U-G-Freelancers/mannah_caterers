    ...
    >
      ...
      <div className="relative w-28 h-28 shrink-0 rounded-xl overflow-hidden">
        ...
        <div className="absolute top-2 right-2 z-10">
          <div className={`size-6 rounded-full flex items-center justify-center transition-all duration-300 ${
            isSelected 
      ...
      <div className="flex flex-col flex-1 py-1 min-w-0">
        <div className="flex justify-between items-start">
          <h4 className={`text-lg font-bold truncate pr-2 transition-colors ${
