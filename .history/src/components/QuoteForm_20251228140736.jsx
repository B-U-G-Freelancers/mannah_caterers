          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative group">
                ...
                <input
                  className="w-full rounded-lg py-3 pl-10 pr-4 bg-[#011c12] border border-[#24473b] text-white focus:outline-none focus:border-[#d4af37] focus:ring-1 focus:ring-[#d4af37] scheme-dark"
                  name="date"
                  type="date"
                  min={minDate}
                  required
