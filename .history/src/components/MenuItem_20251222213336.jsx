    ...
    >
      ...
      <div className="flex flex-col flex-1 min-w-0">
        ...
        <div className="mt-auto pt-1">
          <span
            className={`inline-flex items-center px-2 py-[2px] rounded text-[9px] font-semibold uppercase tracking-wide border ${
              item.isVeg
                ? "bg-[#1a4d2e]/30 border-[#1a4d2e]/40 text-[#4ade80]"
                : "bg-[#451a1a]/25 border-[#451a1a]/40 text-[#f87171]"
            }`}
          >
