...
import { Phone, MessageSquare, MapPin, Mail, Clock, Menu, X } from 'lucide-react';
...
const minDate = tomorrow.toISOString().split("T")[0];
  ...
  action: "https://www.google.com/maps/search/?api=1&query=23/1+TS+Gopal+Nagar+Thiruvottiyur+Chennai+600019",
...
>
  <div className="w-10 h-10 bg-pink-300 rounded flex items-center justify-center cursor-pointer shadow-md transition-all duration-300 hover:scale-125 hover:-translate-y-1 hover:rotate-6 hover:shadow-[0_0_15px_rgba(249,168,212,0.8)]">
    <BsInstagramInstagram size={20} className="text-green-900" />
  </div>
</a>
...
<a href="sms:9884560607">
  ...
  onChange={handleChange} className="w-full bg-transparent border border-yellow-400 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-yellow-400 appearance-none transition-all duration-300 focus:scale-[1.02] focus:bg-green-800/50 focus:shadow-lg hover:border-yellow-300 cursor-pointer">
...
>
  ...
  <iframe
    ...
    src="https://www.google.com/maps?q=23/1+TS+Gopal+Nagar+Thiruvottiyur+Chennai+600019&output=embed"
  />

  {/* Optional CTA */}
  <a
    href="https://www.google.com/maps/search/?api=1&query=23/1+TS+Gopal+Nagar+Thiruvottiyur+Chennai+600019"
    target="_blank"
    rel="noopener noreferrer"
    className="absolute bottom-4 right-4 bg-yellow-400 text-green-900 px-4 py-2 rounded-lg font-semibold shadow-lg hover:bg-yellow-300 transition"
  >
    Open in Maps
  </a>
</section>
        ...
        <footer>
          <div className="border-t border-green-800 pt-6 pb-6">
            <p className="text-center text-yellow-400 hover:text-yellow-200 transition-colors cursor-default">
             © {new Date().getFullYear()} Mannah Caterers. Designed with elegance.
            </p>
          </div>
