          ...
          >
            ...
            <motion.div variants={fadeInUp} className="mt-10 flex flex-wrap gap-4">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-[#e2b857] hover:bg-[#cda446] text-black px-8 py-3.5 rounded font-bold shadow-lg"
              >
                Book a Tasting
              </motion.button>
      ...
      <section className="px-6 lg:px-20 py-24">
        ...
        >
          ...
          <div className="mt-10 flex justify-center gap-4">
            ...
            <button onClick={()=> navigate("/contact")} className="border cursor border-white/20 hover:border-[#e2b857] hover:text-[#e2b857] px-8 py-3.5 rounded">
              Contact Us
            </button>
          </div>
        </motion.div>
