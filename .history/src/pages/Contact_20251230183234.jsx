...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-green-950 to-green-950 overflow-x-hidden">
      ...
      <div
        <div className="relative h-64 transition-opacity duration-1000 opacity-100">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
          ...
          {/* Right Column - Form */}
          <div
            className={`bg-green-900 border-2 border-yellow-400 rounded-2xl p-8 transform transition-all duration-1000 delay-500 hover:shadow-[0_0_30px_rgba(250,204,21,0.15)] ${
