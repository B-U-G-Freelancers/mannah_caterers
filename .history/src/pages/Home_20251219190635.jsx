...
export default function App() {
  ...
  {/* 🖼 Background Image */}
  <img
    src="/biryani-hero.jpg" // 🔴 replace with your image path
  ...
  <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_70%,rgba(250,204,21,0.15),transparent_60%)]" />
