...
useSEO({
  title: "Catering Menu | Biriyani, Starters & Live Counters | Mannah Caterers",
  description:
    "Explore Mannah Caterers' full catering menu featuring chicken & mutton biriyani, starters, desserts and live food counters. Ideal for weddings and events in Chennai.",
});
